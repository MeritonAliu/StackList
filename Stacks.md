List for all sort of stuff (Developer, Student, etc...)
Made by [MeritonAliu](https://github.com/MeritonAliu/) 
31.05.2023

More: [Bigger List](https://github.com/sdmg15/Best-websites-a-programmer-should-visit) 

## FullStack Frameworks
- [Rails MVC](https://rubyonrails.org/)
- [NextJS](https://nextjs.org/)
- [Phoenix with Elixir MVC](https://www.phoenixframework.org/)
- [Astro 2](https://astro.build/)
...
- [Ionic Mobile UI SDK for web apps](https://ionicframework.com/)
- [Material UI](https://mui.com/)
- [Storybook UI Builder](https://storybook.js.org/)
- [Neumorphism generator](https://neumorphism.io/#e0e0e0)
- [Showcase code](https://ray.so/)
- [Keyframes CSS Animations](https://keyframes.app/)
- [Omatsuri, General design tools](https://omatsuri.app/)
- [CSS Layouts](https://csslayout.io/)
- [Color pallete generator](https://coolors.co/)
- [Codepen](https://codepen.io/)
- [Shade Gen](https://maketintsandshades.com/#111111)
...
- [blueTree](https://bluetree.ai/pricing/)
...
## Learning
- [exercism, learn programming](https://exercism.org/)
- [goodbrief, get design brief](https://goodbrief.io/)
- [dev blogs](https://dev.to/)
- [css diner](https://flukeout.github.io/)
- [flexbox froggy](https://flexboxfroggy.com/#de)
- [w3 docs for all](https://www.w3schools.com/) 
...
- [GitHub](https://docs.github.com/en/rest/deployments?apiVersion=2022-11-28)
...
- [MockRocket 3D showcase](https://mockrocket.io/)
- [showcase website/general](https://shots.so/)
- [Color and Psychologie](https://www.ignytebrands.com/the-psychology-of-color-in-branding/)
- [ColorStuff](https://realtimecolors.com/?colors=000000-ffffff-4685ff-f2f2f2-ffb084)
- [Haikel](https://app.haikei.app/)
- [FFFuel](https://fffuel.co/)
- [Google Fonts](https://fonts.google.com/)
- [Coolors](https://coolors.co/)
- [color gen](https://www.learnui.design/tools/accessible-color-generator.html)
- [color plate](https://accessiblepalette.com/)
- [resonable color](https://reasonable.work/colors/)
- 

## Project Tools
- [Octopus Visual Sitemap](https://octopus.do/)
- [Zoho for custom domain Mails](https://www.zoho.com/)
- [Hostpoint Domain](https://www.hostpoint.ch/)
- [Heroku Deploy](https://www.heroku.com/)
- [Trello canban board](https://trello.com/de)
...
- [JavaScript, programming language for the web](https://developer.mozilla.org/en-US/docs/Web/JavaScript)
- [Python, high-level programming language](https://www.python.org/)
- [C, general-purpose programming language](https://en.wikipedia.org/wiki/C_(programming_language))
...
- [Scribe Video tutorial recorder](https://scribehow.com/)
- [Excalidraw](https://excalidraw.com/)
- [Presentation slides with markdown](https://sli.dev/)
- [OmniVim Vim GUI](https://onivim.io)
- [Wappalyzer, find tech of website](https://www.wappalyzer.com/)
- [code sandbox online](https://codesandbox.io/)
...
- [Convert all files](https://convertio.co/de/)
- [Vim, highly configurable text editor](https://www.vim.org/)
- [AWS S3 Cloud](https://aws.amazon.com/de/s3/)

## Dokumentation
- [Readme helper](https://readme.so/de)
...
- [Gun.Io](https://gun.io/)
- [bestvalued](https://bestvalued.com/products/hireable-freelance)
- [toptal](https://www.toptal.com/)
- [freelancer](https://www.freelancer.com/)

## Audio
- [Audio Enhancer with AI](https://podcast.adobe.com/enhance#)
...
- [Bullet, N+1 query finder](https://github.com/flyerhzm/bullet)
- [Simple Forms](https://github.com/heartcombo/simple_form)
- [Sweet alert2](https://github.com/nicolasblanco/sweet-alert2-rails)
...
- [webdesign-inspration](https://www.webdesign-inspiration.com/)
...
- [Dead Cells Wiki](https://deadcells.wiki.gg/wiki/Dead_Cells_Wiki)
